...
public extension ModelStubs {
    ...
    static func dayTime_0900_to_1700(
    ...
    static func nightTime_2200_to_0600(
        rate: MeterSettings.Rate = .init(amount: 400, type: .daily),
        runAtWeekends: Bool = false
    ) -> MeterSettings {
        meterSettings(
    ...
    private static func meterSettings(
        rate: MeterSettings.Rate = .init(amount: 40_000, type: .annual),
